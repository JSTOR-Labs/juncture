  ...
  <main class="dofe-home">
    ...
    <section>
      <ul class="navbar">
        ...
        <li :class="{'active': tab === 'articles'}" @click="tab = 'articles'"><i class="<i class="fa fa-book"></i> Articles</li>
        <li :class="{'active': tab === 'reviews'}" @click="tab = 'reviews'"><i class="<i class="fas fa-glasses"></i>"></i> Reviews</li>
      </ul>
    </section>
